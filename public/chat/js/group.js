//把信息列表群项目模板
var group_queue_item = '<div class="outer on" id="outer_group_#group_id#" data-type="group" data-id="#group_id#">' +
    '<div class="people_out outer">' +
    '<div class="peoples persons fl on" data-type="group" data-id="#group_id#">' +
    '<div class="circle fl"><p class="radius"><img src="/chat/img/grouphead.png" alt=""></p></div>' +
    '<div class="mg fl">' +
    '<p class="tit otw">#group_name#</p>' +
    '<p class="detail otw" id="detail_#group_id#">#message#</p>' +
...
$(document).ready(function(){
    ...
    $('body').delegate(".group_head span.show_userlist", "click", function(){
       ...
       var name = $(this).parent().data('name');
        $('#chat_top .chart_r .head_img').html('<img src="/chat/img/grouphead.png"/>');
        $('#chat_top .chart_r .username').text(name);
       ...
       var obj = $(this);
        ...
        if ($("#outer_group_"+id).length == 0){
            ...
            //把信息队列添加到消息窗口
            var html = group_queue_item;
            html = html.replace(/#group_id#/g, id);
            html = html.replace(/#group_name#/g, name);
...
function get_message_list(id, type, page){
    ...
    var file_style = '<div class="file_style" title="#file_name_old#">\n' +
        '                                <div class="file_menu">\n' +
    ...
    json_get(url, par, function(result){
        ...
        $(data).each(function(i, item){
            ...
            var file_name = subFilename(message.file_name);
            var file_name_old = (message.file_name);
            var float = '';
            ...
            if (tips == 1){
                ...
                if (!file_id){
                    ...
                    text = text.replace(/#file_name_old#/g, file_name_old);
                }
...
function redirect_to_message(id, name, avatar) {
   ...
   // var avatar = $(this).parent().find('img').attr('src');
    ...
    var html = '<div class="outer" id="outer_user_'+id+'" data-type="user" data-id="'+id+'">' +
        '<div class="people_out outer">' +
        '<div class="peoples persons fl" data-type="user" data-id="'+id+'">' +
        '<div class="circle fl">' +
    ...
    $('#chat_top .chart_r .head_img').html('<img src="'+ avatar +'"/>');
    $('#chat_top .chart_r .username').text(name);
