                ...
                for (var j = 0; j < my_GroupList.length; j++) {
                    ...
                    for (var l = 0; l < my_GroupList.length; l++) {
                        ...
                        for (var k = 0; k < list.length; k++) {
                            ...
                            var head = '';
                            head = !list[k]['avatar'] ? head = 'img/head.jpg' : head = list[k]['avatar'];
                            ...
                            if (online_personal !== -1) {
                                ...
                                goupIn += '<p class="radius gray_head" >' +
                                    '<img src="/uploads/' + head + '" alt="" onerror="nofind()" style="width: 100%;height: 100%; border-radius: 50%;border: 29px dotted;border-width: 0vw;margin: 0vw;overflow: hidden;color: #ffffff;position: relative;z-index: 1;">' +
                                    '</p>' +
            ...
            $.post(root_url+"/team/user", "id=" + id, function (data) {
                ...
                if (avatar_d == null) {
                   var avatar = 'img/head.jpg';
                    ...
                    var  avatar = root_url+'/'+avatar_d;
                }
                var sli = '<div class="circle"><p class="radius"><img src="/uploads/'+avatar+'" alt="" onerror="nofind()" style="width: 100%;height: 100%;border-radius: 50%;border: 29px dotted;border-width: 0vw;margin: 0vw;"></p></div><div class="name">'+data_obj['data']['0']['name']+'</div><a href="message.html"><div class="btn_touch">发起对话</div></a>';
                $(".info_right").html(sli);
